...
use "$table/temp/Table_3_total.dta",clear
ap using "$table/temp/Table_3_flu.dta"
ap using "$table/temp/Table_3_non_flu.dta"
...
texsaveyt 	_all using "$tex/tables/Tab3_temp.tex", replace ///
...
filefilter "$tex/tables/Tab3_temp.tex" "$tex/tables/Tab3.tex", from("&&&&&&&&") to("") replace
cap rm "$tex/tables/Tab3_temp.tex"
